  ...
  <div class="grid">
    ...
    <div class="col-12 lg:col-6">
      <div class="card">
        ...
        <Button badge="8" badgeClass="p-badge-danger" class="p-button-warning" icon="pi pi-users"
      ...
      <div class="card">
        ...
        <AvatarGroup class="mb-3">
          <Avatar image="images/avatar/amyelsner.png" shape="circle" size="large"></Avatar>
          <Avatar image="images/avatar/asiyajavayant.png" shape="circle" size="large"></Avatar>
          <Avatar image="images/avatar/onyamalimba.png" shape="circle" size="large"></Avatar>
          <Avatar image="images/avatar/ionibowcher.png" shape="circle" size="large"></Avatar>
          <Avatar image="images/avatar/xuxuefeng.png" shape="circle" size="large"></Avatar>
    ...
    <div class="col-12 lg:col-6">
      ...
      <div class="card">
        ...
        <h5>Image</h5>
        <div class="flex align-items-center flex-column sm:flex-row">
          <Chip class="mr-2 mb-2" image="images/avatar/amyelsner.png" label="Amy Elsner"></Chip>
          <Chip class="mr-2 mb-2" image="images/avatar/asiyajavayant.png" label="Asiya Javayant"></Chip>
          <Chip class="mr-2 mb-2" image="images/avatar/onyamalimba.png" label="Onyama Limba"></Chip>
        </div>
      </div>
