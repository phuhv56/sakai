    ...
    <BlockViewer :code="block1" header="Hero">
      <div class="grid grid-nogutter surface-section text-800">
        ...
        <div class="col-12 md:col-6 overflow-hidden">
          <img alt="Image" class="md:ml-auto block md:h-full" src="images/blocks/hero/hero-1.png"
    ...
    <BlockViewer :code="block4" header="Call to Action">
      <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="text-700 text-center">
          ...
          <Button class="font-bold px-5 py-3 p-button-raised p-button-rounded white-space-nowrap" icon="pi pi-discord"
