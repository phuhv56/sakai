<template>
  <div>
    <div class="card">
      <h3>Icons</h3>
      <p>PrimeVue components internally use <a class="font-medium" href="https://github.com/primefaces/primeicons">PrimeIcons</a>
        library, the official icons suite from <a class="font-medium" href="https://www.primetek.com.tr">PrimeTek</a>.
      </p>
...
export default {
	data() {
      ...
      <p>Here is the current list of PrimeIcons, more icons are added periodically. You may also <a
          class="font-medium" href="https://github.com/primefaces/primeicons/issues">request new icons</a> at the issue
        tracker.</p>
