<template>
  <div class="grid">
    <div class="col-12">
      <div class="card">
        <h5>DataView</h5>
        <DataView :layout="layout" :paginator="true" :rows="9" :sortField="sortField" :sortOrder="sortOrder"
                  :value="dataviewValue">
          <template #header>
          ...
          <template #list="slotProps">
            <div class="col-12">
              <div class="flex flex-column md:flex-row align-items-center p-3 w-full">
                <img :alt="slotProps.data.name" :src="'images/product/' + slotProps.data.image"
                ...
                <div
                  ...
                  <Button :disabled="slotProps.data.inventoryStatus === 'OUTOFSTOCK'" class="mb-2"
                          icon="pi pi-shopping-cart" label="Add to Cart"></Button>
                  <span
