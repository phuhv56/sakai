<template>
  <div class="grid">
        ...
        <div class="grid formgrid">
          <div class="col-6">
            ...
            <OverlayPanel ref="op" :showCloseIcon="true" appendTo="body">
              <img alt="Nature 9" src="images/nature/nature9.jpg"/>
            </OverlayPanel>
          </div>
          <div class="col-6">
            ...
            <OverlayPanel id="overlay_panel" ref="op2" :showCloseIcon="true" appendTo="body" style="width: 450px">
              <DataTable v-model:selection="selectedProduct" :paginator="true" :rows="5" :value="products"
                         responsiveLayout="scroll" selectionMode="single" @row-select="onProductSelect">
                <Column :sortable="true" field="name" header="Name" headerStyle="min-width:10rem;"></Column>
    ...
    <div class="col-12 lg:col-6">
      <div class="card p-fluid">
        <h5>Confirmation</h5>
        <Button class="p-button-danger" icon="pi pi-trash" label="Delete" style="width: auto"
      ...
      <div class="card">
        ...
        <Button class="p-button-warning" icon="pi pi-arrow-right" style="margin-right:.25em"
                @click="visibleLeft = true"/>
        <Button class="p-button-warning" icon="pi pi-arrow-left" style="margin-right:.25em"
                @click="visibleRight = true"/>
        <Button class="p-button-warning" icon="pi pi-arrow-down" style="margin-right:.25em" @click="visibleTop = true"/>
        <Button class="p-button-warning" icon="pi pi-arrow-up" style="margin-right:.25em"
