  ...
  <div class="surface-0 overflow-hidden">
    <div
      ...
      <router-link class="flex align-items-center" to="/">
        <img :src="'layout/images/logo-' + logoColor + '.svg'" alt="Sakai Logo" class="mr-0 lg:mr-2" height="50"><span
          class="text-900 font-medium text-2xl line-height-3 mr-8">SAKAI</span>
      </router-link>
      <a v-ripple v-styleclass="{ selector: '@next', enterClass: 'hidden', leaveToClass: 'hidden', hideOnOutsideClick: true }"
      ...
      <div
        ...
        <ul class="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row cursor-pointer">
          <li>
            <a v-ripple
               class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" @click="smoothScroll('#hero')">
              <span>Home</span>
            </a>
          </li>
          <li>
            <a v-ripple
               class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" @click="smoothScroll('#features')">
              <span>Features</span>
            </a>
          </li>
          <li>
            <a v-ripple
               class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" @click="smoothScroll('#highlight')">
              <span>Highlight</span>
            </a>
          </li>
          <li>
            <a v-ripple
               class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" @click="smoothScroll('#pricing')">
              <span>Pricing</span>
            </a>
          </li>
        </ul>
        <div
          ...
          <Button class="p-button-text p-button-rounded border-none font-light line-height-2 text-blue-500"
                  label="Login"></Button>
          <Button class="p-button-rounded border-none ml-5 font-light text-white line-height-2 bg-blue-500"
    ...
    <div id="hero" class="grid py-4 px-4 lg:px-8 relative">
      <div class="mx-4 md:mx-8 mt-0 md:mt-4">
        ...
        <Button class="p-button-rounded text-xl border-none mt-5 bg-blue-500 font-normal text-white line-height-3 px-3"
                label="Get Started"></Button>
      </div>
      <img alt="hero screen" class="bottom-0" src="layout/images/screen-1.png" style="right:10%;">
    </div>
      ...
      <div class="grid justify-content-center">
        ...
        <div class="col-12 mt-8 mb-8 p-2 md:p-8"
          ...
          <div class="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
            ...
            <img alt="" class="mt-4" src="layout/images/peak-logo.svg">
    ...
    <div id="highlight" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
      ...
      <div class="grid mt-8 pb-2 md:pb-8">
        <div class="flex justify-content-center col-12 lg:col-6 bg-purple-100 p-0 flex-order-1 lg:flex-order-0"
          ...
          <img alt="mockup mobile" class="w-11" src="layout/images/mockup.png">
        </div>
      ...
      <div class="grid my-8 pt-2 md:pt-8">
        ...
        <div class="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 bg-yellow-100 p-0"
             style="border-radius:8px;">
          <img alt="mockup" class="w-11 pt-4" src="layout/images/mockup-desktop.png">
        </div>
      </div>
    </div>
      ...
      <div class="grid justify-content-between mt-8 md:mt-0">
        <div class="col-12 lg:col-4 p-0 md:p-3">
          <div class="p-3 flex flex-column border-200 hover:border-cyan-200"
            ...
            <img alt="" class="w-10 h-10 mx-auto" src="layout/images/asset-tier-1.svg">
            <div class="my-5 text-center">
              <span class="text-5xl font-bold mr-2 text-900">$0</span>
              <span class="text-600">per month</span>
              <Button class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light text-white line-height-2 bg-blue-500"
                      label="Get Started"></button>
            </div>
        ...
        <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
          <div class="p-3 flex flex-column border-200 hover:border-cyan-200"
            ...
            <img alt="" class="w-10 h-10 mx-auto" src="layout/images/asset-tier-2.svg">
            <div class="my-5 text-center">
              <span class="text-5xl font-bold mr-2 text-900">$1</span>
              <span class="text-600">per month</span>
              <Button class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light text-white line-height-2 bg-blue-500"
                      label="Try Free"></Button>
            </div>
            <Divider class="w-full bg-surface-200"></Divider>
            <ul class="my-5 list-none p-0 flex text-900 flex-column">
              <li class="py-2">
        ...
        <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
          <div class="p-3 flex flex-column border-200 hover:border-cyan-200"
            ...
            <img alt="" class="w-10 h-10 mx-auto" src="layout/images/asset-tier-3.svg">
            <div class="my-5 text-center">
      ...
      <div class="grid justify-content-between">
        <div class="col-12 md:col-2" style="margin-top:-1.5rem;">
          <div class="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3">
            <img :src="'layout/images/logo-' + logoColor + '.svg'" alt="footer sections" class="mr-2" height="50"
                 width="50">
          ...
          <div class="grid text-center md:text-left">
            ...
            <div class="col-12 md:col-3 mt-4 md:mt-0">
              ...
              <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">Events<img
                  class="ml-2" src="layout/images/new-badge.svg"/></a>
